...
<template>
    <form @submit.prevent="HandleSubmit" class="flex flex-col gap-4 pb-5 m-auto text-slate-200">
        ...
        <div class="w-full">
            <Button type="submit" class="py-2 px-4 text-white bg-blue-500 rounded hover:bg-blue-600" @click="handleSubmit">
                {{ buttonLabel }}
            </Button>
        </div>
    </form>
