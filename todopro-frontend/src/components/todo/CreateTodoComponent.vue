...
// Creates a new todo and updates the todo list based on the current route.
...
<template>
    <div class="w-full">
        <form data-test="form" @submit.prevent="createTodo" class="flex flex-col gap-4 pb-5 m-auto text-slate-200">
            ...
            <div class="flex flex-col">
                ...
                <input data-test="title" type="text" v-model="form.title" id="title" required
            ...
            <div class="flex flex-col">
                ...
                <textarea data-test="description" v-model="form.description" id="description" rows="5" required
            ...
            <div class="flex gap-2">
                ...
                <input data-test="completed" type="checkbox" v-model="form.completed" id="completed"
            ...
            <div class="w-full">
                <Button type="submit" class="py-2 px-4 text-white bg-blue-500 rounded hover:bg-blue-600">Create
                    Todo</Button>
            </div>
        </form>
    </div>
